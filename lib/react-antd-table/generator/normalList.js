...
// 需要生成的配置json路径
const Config = require('../schema/normalList/config')
const DataSchema = require('../schema/normalList/dataSchema')
const QuerySchema = require('../schema/normalList/querySchema')
