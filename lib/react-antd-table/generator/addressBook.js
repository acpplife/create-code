...
// 需要生成的配置json路径
const Config = require('../schema/addressBook/config')
const DataSchema = require('../schema/addressBook/dataSchema')
const QuerySchema = require('../schema/addressBook/querySchema')
