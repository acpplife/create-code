...
module.exports = (tableConfig) => {
  ...
  return `
        ...
        ${!newRouterMode && !onlyTableListMode ? "import TableForm from './components/TableForm'" : ''}
        ...
        function Table (props) {
            ...
            function handleStandardTableChange (_pagination, filtersArg, sorter) {
                const params = getFormatParamsFromTable(_pagination, filtersArg, sorter, location.query)
            ...
            return (
                ...
                ${!newRouterMode && !onlyTableListMode ?
                `<TableForm
                    modalType={modalType}
                    current={current}
